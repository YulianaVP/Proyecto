...
class DGrupo11 extends React.Component {
  render() {
    return (
      <div>
        ...
        <h1 className="Grupos">Grupo 11</h1>
        <h2 className="Grupos2">Alumnos:</h2>

        <Lista
        nombre="DIOSA ALVAREZ DAVID"
        img={boy1}
        questionsefc="1"
        questionseff="1"
        questionsbc="2"
...
<Lista
        nombre="MARTINEZ CHAVERRA MANUELA"
        img={girl1}
        questionsefc="1"
        questionseff="1"
        questionsbc="2"
...
<Lista
        nombre="BUITRAGO PARRA JHOAN DANIEL"
        img={boy2}
        questionsefc="1"
        questionseff="1"
        questionsbc="2"
