...
class DGrupo10 extends React.Component {
  render() {
    return (
      <div>
        ...
        <h1 className="Grupos">Grupo 10</h1>
        <h2 className="Grupos2">Alumnos:</h2>

        <Lista
        nombre="AMARILES BEDOYA DANIA"
        img={girl1}
        questionsefc="1"
        questionseff="1"
        questionsbc="2"
...
<Lista
        nombre="CASAS JAIMES CARLOS ALBERTO"
        img={boy1}
        questionsefc="1"
        questionseff="1"
        questionsbc="2"
...
<Lista
        nombre="GALLEGO RICARDO ISABELLA"
I        img={girl2}
        questionsefc="1"
        questionseff="1"
        questionsbc="2"
...
<Lista
        nombre="GARCES DELGADO EDWIN DUVAN"
        img={boy2}
        questionsefc="1"
        questionseff="1"
        questionsbc="2"
